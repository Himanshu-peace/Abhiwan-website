export const metadata = {
  title: "Terms & Conditions | Abhiwan Technology",
  description: "Terms & Conditions of Abhiwan Technology Pvt. Ltd.",
};
  ...
  return (
    <section >
      <div className="max-w-6xl mx-auto px-6 py-16 leading-relaxed">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-[85px] flex items-center justify-center font-extrabold uppercase mb-6">
          terms & conditions
        </h1>
        ...
        <section className="space-y-4 mb-12">
          <h2 className="text-2xl font-bold">
            Terms & Conditions for Abhiwan Technology
          </h2>
        ...
        <section className="mb-12 ">
          ...
          <h3 className="text-xl font-bold mb-6">Definitions</h3>
          ...
          <ul className="list-disc pl-6 ">
            ...
            <li>
              Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Abhiwan Technology Pvt. Ltd., Building No. 32, H Block, Syadwad Business Park, Sector 63, Noida.
            </li>
            <li>
            ...
            <li>
              Website refers to Abhiwan Technology, accessible from https://www.abhiwan.com/
            </li>
            <li>
        ...
        <section className="mb-12 ">
          ...
          <p className="mb-6">
            ...
            <ul className="list-disc pl-6">
                <li>By Email: Sales@abhiwan.com</li>
                <li>By visiting this page on our website: https://www.abhiwan.com/contactus</li>
                <li>By phone: +91 - 9599145805</li>
            </ul>
          </p>
        </section>
      </div>
