export const metadata = {
  title: "Privacy Policy | Abhiwan Technology",
  description: "Privacy Policy of Abhiwan Technology Pvt. Ltd.",
};

export default function PrivacyPolicyPage() {
  return (
    <section >
      <div className="max-w-6l mx-auto px-6 py-16 leading-relaxed">

        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[110px] flex items-center justify-center font-extrabold uppercase mb-6">
          Privacy Policy
        </h1>
        ...
        <section className="space-y-4 mb-12">
          <h2 className="text-2xl font-bold">
            Privacy Policy for Abhiwan Technology
          </h2>
        ...
        <section className="mb-12">
          ...
          <h4 className="font-bold mb-6">Business Transactions</h4>
          <p className="mb-6">
            If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
          </p>

          <h4 className="font-bold mb-6">Law enforcement</h4>
          <p>
          ...
          <h4 className="font-bold mb-6">Security of Your Personal Data</h4>
          <p className="mb-6">
            The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially reasonable means to protect Your Personal Data, We cannot guarantee its absolute security.          
          </p>

          <h4 className="font-bold mb-6">Children's Privacy</h4>
          <p className="mb-6">
          ...
          <h4 className="font-bold mb-6">Links to Other Websites</h4>
          <p className="mb-6">
          ...
          <h4 className="font-bold mb-6">Changes to this Privacy Policy</h4>
          <p className="mb-6">
