                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <img
                                            src={cat.icon}
                                            alt=""
                                            className={`w-6 h-6 shrink-0 ${activeCategory === cat.id ? "invert" : ""}`}
                                        />
                        ...
                        <div className="flex-1 p-8 overflow-y-auto">
                            <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-8">
                                ...
                                <div className="w-full max-w-90 flex flex-col">
                                    ...
                                    <div className="h-120 overflow-y-auto pr-2 space-y-2">
                                        {SERVICES_MAP[activeCategory]?.map((service, i) => (
                                            <div
                                                key={i}
                                                className="px-4 py-2 rounded-md text-sm cursor-pointer transition border border-transparent hover:text-purple-500 hover:border-purple-500 whitespace-nowrap"
                                            >
                                                {service}
                                            </div>
                                        ))}
                                ...
                                <div>
                                    ...
                                    <div className="mt-4 relative h-35">
                                        ...
                                        <div className="absolute bottom-0 -my-5 left-0 p-px rounded-md bg-linear-to-r from-[#3952FC] to-[#7F15DC]">
