  ...
  return (
    <section id="portfolio" className=" py-10 bg-white">
      <div className="container mx-auto px-4 relative">
        ...
        <div className="">
          <h2
            className="pl-10 xl:pl-16 
              uppercase mb-12 font-futura font-bold
        ...
        {/* MOBILE BUTTONS */}
        <div className="flex md:hidden justify-center gap-15 mt-6">
          <button
            onClick={scrollLeft}
            className="w-12 h-12 flex items-center justify-center bg-[#181C41] rounded-full"
          >
            <ChevronLeft className="w-6 h-6 text-white" />
          </button>
        ...
        <div className="mt-12 mx-auto w-fit group">
          <div
            className="
              p-0.75 rounded-[36.38px]
              transition-all duration-300
              group-hover:bg-linear-to-r
              group-hover:from-[#3952FC]
              group-hover:to-[#7F15DC]
            "
          >
            <button
              className="
